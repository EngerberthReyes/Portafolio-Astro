...
const mensajeContrasenia = document.getElementById('input-mensaje__contrasenia');

const contraseniaRegistrada = document.getElementById('input-mensaje__contrasenia-registrada');
...
mensajeContraseniaRegistrada.classList.add('container-error_contrasenia-registrada');

mensajeContraseniaRegistrada.innerText = 'La Contraseña Ingresada No es Correcta';
...
mensajeNombreAgregadoOchoCaracteres.classList.add('container-error_contrasenia');

mensajeNombreAgregadoOchoCaracteres.innerText = 'Introduzca Una Contraseña Que Sea o Tenga Más de 8 Caracteres.';
